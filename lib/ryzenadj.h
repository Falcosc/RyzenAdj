...
#define PMTABLE_ERR_FAM_UNSUPPORTED      -1
...
EXP float CALL get_max_gfxclk_freq(ryzen_access ry);
EXP float CALL get_min_gfxclk_freq(ryzen_access ry);
EXP float CALL get_max_socclk_freq(ryzen_access ry);
EXP float CALL get_min_socclk_freq(ryzen_access ry);
EXP float CALL get_max_fclk_freq(ryzen_access ry);
EXP float CALL get_min_fclk_freq(ryzen_access ry);
EXP float CALL get_max_vcn(ryzen_access ry);
EXP float CALL get_min_vcn(ryzen_access ry);
EXP float CALL get_max_lclk(ryzen_access ry);
EXP float CALL get_min_lclk(ryzen_access ry);
EXP float CALL get_prochot_deassertion_ramp(ryzen_access ry);
